...
const ALL_IMAGES = [
  ...
  { id:'h2',  src:'/images/hero_furniture.png',    name:'Showroom Nội Thất',          cat:'interior' },
  // ADV
  ...
  { id:'a37', src:'/images/product_lightbox.png',  name:'Biển Hộp Đèn Premium',      cat:'adv' },
  { id:'a38', src:'/images/product_alu.png',       name:'Biển Alu Cao Cấp',          cat:'adv' },
  { id:'a39', src:'/images/product_raised.png',    name:'Chữ Nổi Inox',              cat:'adv' },
  { id:'a40', src:'/images/project_showcase1.png', name:'Công Trình Biển Hiệu',      cat:'adv' },
  // EVENT
  ...
  { id:'e9',  src:'/images/event_booth.png',       name:'Booth Triển Lãm',           cat:'event' },
  { id:'e10', src:'/images/event_standee.png',     name:'Standee & Banner',          cat:'event' },
  { id:'e11', src:'/images/event_arch.png',        name:'Cổng Chào Sự Kiện',        cat:'event' },
  { id:'e12', src:'/images/event_led_screen.png',  name:'Màn Hình LED Sân Khấu',    cat:'event' },
  { id:'e13', src:'/images/event_popup_booth.png', name:'Lều Popup Quảng Cáo',      cat:'event' },
  { id:'e14', src:'/images/event_signage_set.png', name:'Bộ Biển Chỉ Dẫn',         cat:'event' },
  { id:'e15', src:'/images/event_photobooth.png',  name:'Khung Photo Booth',         cat:'event' },
  // INTERIOR
  { id:'i1',  src:'/images/22_Interior.webp',      name:'Nội Thất Cao Cấp',          cat:'interior' },
  { id:'i2',  src:'/images/product_cabinet.png',   name:'Tủ Gỗ Công Nghiệp',         cat:'interior' },
  { id:'i3',  src:'/images/product_shelf.png',     name:'Kệ Trưng Bày',              cat:'interior' },
  { id:'i4',  src:'/images/project_showcase2.png', name:'Công Trình Nội Thất',       cat:'interior' },
